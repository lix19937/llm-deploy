...
|transformer-based(decoder)| [tensorrt-llm](tensorrt-llm/readme.md)  https://github.com/NVIDIA/TensorRT-LLM<br>对于无cnn的，如GPT2，不借助onnx解析器，自己搭建网络推理，典型的llama.cpp，llama2.c 这类针对特定结构开发的推理项目，<br>以及 [vllm](./vllm/readme.md) https://lilianweng.github.io/posts/2023-01-10-inference-optimization/#distillation  |- |    
